---
title: Как работает pwa-doc?
sidebar_label: Как работает pwa-doc
sidebar_position: 1
---

### Контекст

Для понимания принципов работы pwa-doc нужно знать, что эта система состоит из 2 компонентов:
...
Преимуществом pwa-doc является то, что для него не нужна отдельная директория для хранения зависимостей, а значит
...
файла `@pwa-doc/app/root/docusaurus.config.js`
